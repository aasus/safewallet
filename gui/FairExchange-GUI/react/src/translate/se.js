...
export const LANG_SE = {
  'WALLETS_INFO': {
    ...
    'INBOUND': 'Inkommande',
    'TIME_OFFSET': 'Tids kompensering',
    'PING_TIME': 'Ping tid',
    'CONNECTION_TIME': 'Tid ansluten',
    'LAST_SEND': 'Sist skickad',
    'LAST_RECEIVED': 'Sist mottagen',
    'DATA_SENT': 'Data skickat',
    'DATA_RECEIVED': 'Data mottaget',
    'BAN_SCORE': 'Bannlysnings poäng',
    'STARTING_HEIGHT': 'Start höjd',
    'SYNCED_HEADERS': 'Synkade huvuden',
    'SYNCED_BLOCKS': 'Synkade block',
    'NETWORK_TOTALS': 'Nätverks totaler',
    'TIME': 'Tid',
    'PEERS': 'Jämnlikar',
    'LOADING': 'Laddar...',
  },
  'IMPORT_KEY': {
    ...
    'TWO_FORMS_BELOW_P1': 'Två formulär nedanför kan du importara vilken som',
    'TWO_FORMS_BELOW_P2': 'Lösenordsfras (seed) eller',
    'TWO_FORMS_BELOW_P3': 'nyckel',
    'PASSPHRASE': 'Lösenordsfras / seed',
    'NOTICE': 'Notera',
    'NOTICE_DESC': 'vid importering av lösenordsfras kommer en fullständig plånboks skanning att ske',
    'SAFE_RESCAN_WARNING_TIME': 'Det kan ta flera timmar för denna process att skanna om hela blockkedjan',
    'SHOW_ADDRESS_AND_WIF': 'Visa adress och WIF',
    'ADDRESS': 'Adress',
    'OR': 'eller',
    'TRIGGER_RESCAN': 'Starta skanning',
    'RESCAN_TIP': 'Använd det här alternativet om du vill starta en skanning av plånboken direkt efter att WIF är importerad. Om du har flera adresser som skall importeras, lägger du in dem en & en och sätter på det här alternativet på den sista adress importen.',
    'WIF_KEY': 'WIF nyckel',
    'IMPORT_AND_RESCAN': 'Importera och skanna om',
  },
  'CLAIM_INTEREST': {
    'SHOW_ZERO_INTEREST': 'Visa noll ränta',
    'REQ_P1': 'Uppfyllnadskrav för att få ränta',
  ...
  'ABOUT': {
    ...
    'SAFEWALLET_MODES': 'Safewallet är en applikation som kan användas som plånbok till ett flertal krypto-valutor. ' +
                   'När du skapar en plånbok, kan du konfigurera den att operera i följande lägen:',
    'NATIVE_MODE_DESC': 'Endast tillgänglig för ett fåtal valutor. Som \'Full Mode\' fast med avancerad funktionalitet.',
    'SAFEWALLET_CAPABILITIES': 'Safewallet har kapacitet att göra följande:',
    'BARTER_DEX_DESC': 'Växla kryptovalutor enkelt genom en transformers liknande service.',
    'SAFEWALLET_NOTE': 'Notera: Safewallet är fortfarande under utveckling. ' +
                  'Den är söker att använda, men du ska alltid göra ordentliga backuper. ' +
                  'Vi rekommenderar att du inte använder den som den primära plånboken för dina andra kryptovalutor.',
    'TESTERS': 'Testare',
    'TESTERS_P1': 'Du kan hjälpa oss att testa Safewallet.',
    'TESTERS_P2': 'Bara ladda ner & installera senaste releasen',
    'TESTERS_P3': 'Sedan kan du rapportera eventuella buggar till våra utvecklare',
    'TESTERS_P4': 'Din hjälp är varmt välkommen!',
    'SAFEWALLET_DAPPS': 'Safewallet stödjer även följande applikationer och funktioner:',
    'JUMBLR_DESC': 'En decentraliserad Bitcoin blockkedje-tumlare för avskildhet och lägre avgifter.',
    'BARTER_DEX_DESC_ALT': 'Ett decentraliserat växlings kontor.',
    'CHANNEL': 'Kanal',
    'GET_AN_INVITE': 'Skaffa en inbjudan',
    'GET_AN_INVITE_P2': 'till våran slack om du inte är registrerad än'
  },
  'API': {
    'DAEMON_IS_STILL_RUNNING': 'Tjänsten körs fortfarande. Använd stopp ikonen nästa gång för att stanna & ta bort tjänsten helt.',
    'CONN_ERROR': 'Anslutnings fel',
    'SAFE_PASSIVE_ERROR': 'Vänligen se till att köra safecoind manuellt',
    'ERROR_SM': 'error',
    'ADDRESS_ALREADY_REG': 'Adress redan registrerad',
    'COULDNT_COPY_ADDRESS': 'Kunde inte kopiera adressen till urklipp',
    'COULDNT_CREATE_SEED': 'Kunde inte skapa ett nytt plånboks seed',
    'WALLETDAT_MISMATCH': 'Din wallet.dat matchar inte blockkedjan. Please restart the wallet with -reindex param.',
