...
export const LANG_EN = {
  ...
  'IMPORT_KEY': {
    ...
    'SAFE_RESCAN_WARNING_TIME': 'Det kan ta flera timmar för denna process att skanna hela blockkedjan',
    'SHOW_ADDRESS_AND_WIF': 'Visa adress och WIF',
    'ADDRESS': 'Adress',
    'OR': 'eller',
    'TRIGGER_RESCAN': 'Starta skanning',
    'RESCAN_TIP': 'Använd det här alternativet om du vill starta en skanning av plånboken direkt efter WIF är importerad. Om du har flera adresser som skall importeras, lägger du in dem en & en och sätter på det här alternativet på den sista adress importen.',
    'WIF_KEY': 'WIF nyckel',
  ...
  'ABOUT': {
    ...
    'SAFEWALLET_MODES': 'Safewallet är en applikation som kan användas som plånbok till multipla krypto-valutor. ' +
