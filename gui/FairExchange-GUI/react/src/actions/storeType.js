...
/* SAFE PRICES */
export const SAFE_BTC_RATE = 'SAFE_BTC_RATE';
export const BTC_USD_RATE = 'BTC_USD_RATE';

/* SAFE TRADE*/
export const SAFE_TRADE_PAIR_LIST = 'SAFE_TRADE_PAIR_LIST';
export const SAFE_TRADE_CHANGE_ACTIVE_PAIR = 'SAFE_TRADE_CHANGE_ACTIVE_PAIR';
export const SAFE_TRADE_TICKERS = 'SAFE_TRADE_TICKERS';
export const SAFE_VOTE = 'SAFE_VOTE';