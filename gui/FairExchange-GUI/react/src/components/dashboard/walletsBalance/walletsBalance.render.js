    ...
    <div
      ...
      { this.renderBalance('transparent') !== -777 &&
        <div className="col-xs-12 flex">
          <div className={ this.props.ActiveCoin.coin === 'CHIPS' || (this.props.ActiveCoin.mode === 'spv' && this.props.ActiveCoin.coin !== 'SAFE') || this.renderBalance('total') === this.renderBalance('transparent') || this.renderBalance('total') === 0 ? 'col-lg-12 col-xs-12 balance-placeholder--bold' : 'col-lg-3 col-xs-12' }>
          ...
          <div className={ this.props.ActiveCoin.coin === 'CHIPS' || (this.props.ActiveCoin.coin !== 'SAFE' && this.props.ActiveCoin.mode === 'spv') || Number(this.renderBalance('total')) === 0 || this.renderBalance('total') === this.renderBalance('transparent') ? 'hide' : 'col-lg-3 col-xs-12' }>
            <div className="widget widget-shadow">
              <div className="widget-content">
                <div className="padding-20 padding-top-10">
                  <div className="clearfix cursor-default">
